export default function Services() {
    return (
        <section className='bg-[#DFCCC2] md:h-[130vh]'>
            ...
            <div className='flex flex-col md:flex-row lg:gap-5 lg:w-[70%] justify-center mx-auto'>
                <div className='w-[20%] lg:w-[30%]'>
                    <img src="image-8.png" alt="" className="min-w-[10rem] h-[17rem]" />
                ...
                <div className='md:w-[40%] lg:p-20 '>
                    ...
                    <div className='flex flex-row relative w-full h-full'>
                        <img src="image-9.png" alt="" className='z-[10] object-cover min-w-[15rem] h-[32rem] ' />
                ...
                <div className='md:w-[30%]'>
                    <div className='flex flex-row relative shrink-0'>
                        <img src="image-10.png" alt="" className='mt-[5rem] z-[10] min-w-[13rem] h-[22rem] ' />
                        <div className='flex flex-col'>
                            <img src="abstract-4.png" alt="" className='hidden md:block absolute right-[-50%] lg:right-[-10%] top-[25%] lg:top-[45%] w-[15rem] h-[15rem]' />
                        </div>
                    </div>
